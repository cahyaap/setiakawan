        ...
        <div class="white-box">
            ...
            <div class="row">
                <div class="col-md-12 transaksi-button-list">
                    ...
                    {{-- <button id="3" data-transaksi="pengeluaran" class="btn btn-default transaksi-button">Pengeluaran</button> --}}
                </div>
            ...
            <div class="tab-list">
                ...
                {{-- <div class="tab" id="pengeluaran">Pengeluaran</div> --}}
            </div>
            ...
            {{-- <div class="row transaksi" id="tab-pengeluaran" style="display: none;">
                <div id="tabel-pengeluaran-box" class="col-md-12 table-responsive">
                    <div class="load-content text-center"><span><i class="fa fa-spinner fa-spin"></i></span></div>
                    <table id="tabel-pengeluaran" class="display" cellspacing="0" width="100%">
                        Tabel pengeluaran
                    </table>
                </div>
            </div> --}}
