...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <div class="row">
                <div class="col-md-8">
                    <h3 class="box-title" style="margin-top: 10px;margin-bottom: -10px">Update Stok Opname - {{ date('d F Y, h:i:s A', strtotime($stokOpname->created_at)) }}</h3>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('stok-opname.update', $id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <input type="hidden" name="stok_web[]" id="stok-web-{{ $item->id }}" value="{{ $stokWeb }}">
                                            <input type="number" step="0.01" name="stok_real[]" id="stok-real-{{ $item->id }}" data-barang-id="{{ $item->id }}" value="{{ $stokReal }}" class="text-center stok-real" required>
                                        </td>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ket" id="ket" rows="4" class="form-control" placeholder="Masukkan keterangan disini...">{{ $stokOpname->ket }}</textarea>
                        </div>
